...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20220220213626_FixDefaultRatingFormat")]
    partial class FixDefaultRatingFormat
    {
            ...
            modelBuilder.Entity("Infrastructure.Data.Models.Games.Stats.QuizStats", b =>
                {
                    ...
                    b.Property<float>("Rating")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("real")
                        .HasComputedColumnSql("IIF([GamesCount] != 0, CAST([WinsCount] AS REAL) / [GamesCount] * 100.0, 0.0)", true);
